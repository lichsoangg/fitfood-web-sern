...
export default function ProductItem({ image, id, name, rating, price, unit, soldQuantity, hoverColor = '#ffffff' }) {
  return (
    <Link to={`${path.menu}/${generateUrlByNameAndId({ name, id })}`}>
      <div className='product-item'>
        <div className='product-item__icon'>
          <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path d='M10.7901 15.17C10.5901 15.17 10.4001 15.09 10.2601 14.95L7.84006 12.53C7.55006 12.24 7.55006 11.76 7.84006 11.47C8.13006 11.18 8.61006 11.18 8.90006 11.47L10.7901 13.36L15.0901 9.06003C15.3801 8.77003 15.8601 8.77003 16.1501 9.06003C16.4401 9.35003 16.4401 9.83003 16.1501 10.12L11.3201 14.95C11.1801 15.09 10.9901 15.17 10.7901 15.17Z' />
        ...
        <div className='product-item__overlay' style={{ outlineColor: `${hoverColor}` }} />
        ...
        <div className='product-item__info'>
          ...
          <div className='rating-and-sold'>
            ...
            {rating ? <span>|</span> : <></>}
            <span>Đã bán {formatNumberToSocialStyle(soldQuantity)}</span>
          </div>
          <span>
            <strong>{formatCurrency(price)}đ</strong>/{unit}
          </span>
        </div>
      </div>
    </Link>
