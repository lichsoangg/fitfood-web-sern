    ...
    <div className='layout__function'>
      <div className='layout__function--cart'>
        <svg width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
            d='M17 6H7.00002M17 6H18.3087C20.3944 6 21.4373 6 22.0335 6.66616C22.6298 7.33231 22.5146 8.36879 22.2843 10.4417L21.9884 13.1043C21.5183 17.3356 21.2832 19.4513 19.8594 20.7256C18.4356 22 16.2904 22 12 22C7.70962 22 5.56443 22 4.14063 20.7256C2.71683 19.4513 2.48176 17.3356 2.01161 13.1043L1.71577 10.4417C1.48544 8.36879 1.37028 7.33231 1.96652 6.66616C2.56276 6 3.60561 6 5.6913 6H7.00002M17 6C17 3.23858 14.7614 1 12 1C9.30679 1 7.1109 3.12938 7.00409 5.79641C7.00139 5.86394 7.00002 5.93181 7.00002 6'
            stroke='#000000'
            strokeWidth='1.5'
          />
          <path
