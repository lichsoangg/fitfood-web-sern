...
const faqss = [
  {
    id: uuidv4(),
    title: 'Mô hình của Fitfood là gì?',
    descriptions: [
      {
        id: uuidv4(),
        content:
  ...
  {
    id: uuidv4(),
    title: 'Cách đặt hàng như thế nào?',
    descriptions: [
      {
        id: uuidv4(),
        content:
          'Bạn chọn gói ăn bạn mong muốn tại trang đặt hàng, đừng quên thêm vào giỏ hàng các sản phẩm dùng kèm nha. Sau khi cho hết các sản phẩm vào giỏ hàng, bạn chỉ cần điền đầy đủ thông tin giao hàng trên website, chọn thời gian giao hàng và hình thức thanh toán COD hoặc chuyển khoản.'
      },
      {
        id: uuidv4(),
        content:
          'Nếu gặp bất cứ khó khăn nào trong quá trình đặt hàng, hãy gọi ngay số Hotline của Fitfood. 0932 788 120 - 0938 074 120. hoặc inbox Fanpage : m.me/fitfoodvietnam'
      }
    ]
  },
  {
    id: uuidv4(),
    title: 'Các lưu ý khi sử dụng Fitfood',
    descriptions: [
      {
        id: uuidv4(),
        content:
          'Để đạt chuẩn VSATTP, các phần ăn của Fitfood đều được cấp đông và đóng gói ngay sau khi chế biến nhằm đảm bảo chất lượng và tránh ôi thiu trong quá trình vận chuyển.'
      },
      {
        id: uuidv4(),
        content:
      ...
      {
        id: uuidv4(),
        content: 'Hộp nhựa đen của Fitfood là nhựa PP, hàng xuất khẩu Singapore nên an toàn sử dụng trong lò vi sóng ạ.'
      },
      {
        id: uuidv4(),
        content:
          'Đối với các khách không có tủ lạnh hoặc không hâm nóng bằng Lò Vi Sóng, Fitfood không đảm bảo chất lượng thức ăn tốt nhất.'
      }
    ]
  },
  {
    id: uuidv4(),
    title: 'Phần ăn Fitfood có gì đặc biệt',
    descriptions: [
      {
        id: uuidv4(),
        content:
  ...
  {
    id: uuidv4(),
    title: 'Thức ăn Fitfood nhạt quá, phải làm sao?',
    descriptions: [
      {
        id: uuidv4(),
        content:
  ...
  {
    id: uuidv4(),
    title: 'Ăn bao lâu và ăn gói nào để giảm cân?',
    descriptions: [
      {
        id: uuidv4(),
        content:
  ...
  {
    id: uuidv4(),
    title: 'Fitfood thải ra nhựa nhiều quá?',
    descriptions: [
      {
        id: uuidv4(),
        content:
      ...
      },
      {
        id: uuidv4(),
        content:
          '1/ Hộp nhựa đen được sử dụng trong tất cả các phần ăn của Fitfood. Vì vậy, Fitfood có chính sách Rửa Sạch Hộp và gửi lại cho Fitfood để nhận được Hoàn Tiền. Cứ mỗi 10 hộp gửi trả lại cho shipper, bạn sẽ nhận lại ngay 10,000 vnd. Bạn vui lòng hoàn trả hộp theo bội số của 10 để nhân viên tiện hoàn tiền lại cho bạn. Các hộp này sẽ được gửi lại cho nhà sản xuất để tái chế. '
      },
      {
        id: uuidv4(),
        content: '2/ Chính sách của Fitfood là chỉ cung cấp một bộ Muỗng Nĩa mỗi ngày'
      },
      {
        id: uuidv4(),
        content:
      ...
      },
      {
        id: uuidv4(),
        content:
          '* Fitfood có thử nghiệm sử dụng hộp bã mía một thời gian. Tuy nhiên, hộp bã mía không đảm bảo được chất lượng sản phẩm trong quá trình vận chuyển ảnh hưởng lớn đến trải nghiệm khách hàng. Bên mình vẫn sẽ tiếp tục tìm kiếm các giải pháp thân thiện với môi trường và Fitfood sẽ thông báo sớm đến tất cả các bạn khi bên mình có giải pháp mới hoàn thiện hơn!'
      }
    ]
  },
  {
    id: uuidv4(),
    title: 'Tại sao lại giao phần ăn cấp đông?',
    descriptions: [
      {
        id: uuidv4(),
        content:
          'Fitfood sử dụng quy trình cấp đông làm lạnh nhanh ngay sau khi nấu chín giúp hạn chế sự phát triển của vi khuẩn, đồng thời đảm bảo được chất lượng thức ăn luôn tươi ngon. Quy trình tiêu chuẩn này đã được kiểm nghiệm bởi Cục Quản lý Vệ Sinh An Toàn Thực Phẩm và được áp dụng rộng rãi ở các nước phát triển cũng như các suất ăn hàng không hoặc khách sạn 5 sao.'
      },
      {
        id: uuidv4(),
        content:
          'Fitfood cam kết không bao giờ sử dụng các phần ăn đông lạnh để giao đến cho khách hàng. Các phần ăn của Fitfood luôn được chuẩn bị mới mỗi ngày và được giữ mát trong suốt quá trình vận chuyển. Nếu thực phẩm giao nóng trong thời tiết TPHCM rất dễ bị hư hỏng và làm cho các vi khuẩn gây hại phát triển.'
      },
      {
        id: uuidv4(),
        content: 'Bạn vui lòng bỏ các phần ăn vào tủ lạnh ngay khi nhận để đảm bảo chất lượng tốt nhất. '
      }
    ]
  }
]
