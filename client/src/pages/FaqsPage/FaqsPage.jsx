  ...
  return (
    <div className="faqs">
      <div className="mainWrapper container">
        ...
        <p className="faqs-description">Bạn muốn trải nghiệm Fitfood nhưng không biết bắt đầu từ đâu? Hãy tham khảo những câu hỏi thường gặp bên dưới.</p>
        <div className="faqs-list">
          {
            faqss && faqss.map((faqs) => {
              return <FaqsItem title={faqs.title} handleClickOpenItem={handleClickOpenItem} descriptions={faqs.descriptions} />
            })
          }
        </div>
      </div>
