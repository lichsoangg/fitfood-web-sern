    ...
    <div className="faqs-item">
      ...
      <div className="faqs-item__content-list" >
        {descriptions && descriptions.map((description) => {
          return <p className="faqs-item__content-list--item" key={description.id}>
            {description.content}
          </p>
        })}
      </div>
