        ...
        <div className='employees-management__table-wrapper'>
          <div className='employees-management__table'>
            ...
            <div className='employees-management__table--row'>
              <div className='table-data'>Mã hóa đơn</div>
              <div className='table-data'>Ngày tạo</div>
              <div className='table-data'>Trạng thái</div>
              <div className='table-data'>Nhân viên</div>
              <div className='table-data'>Khách hàng</div>
              <div className='table-data'>Đơn giá</div>
              ...
              data.map((bill) => {
                return (
                  <div key={bill?.BillID} className='employees-management__table--row'>
                    ...
                    <div className='table-data'>{bill.EmployeeName}</div>
                    <div className='table-data'>{bill.CustomerName}</div>
                    <div className='table-data'>{bill.Revenue}</div>
        ...
        {openInputEmployee && (
          <ModalBase styleContent={{ width: '1100px', height: 'max-content' }} setOpen={setOpenInputEmployee}>
            <div className='employeeInput__form'>
              ...
              <div className='formInput' style={{ width: 'calc(40% - 16px)' }}>
                <input type={'text'} className='formInput__input' placeholder=' ' autoComplete='off' />
                <span className='formInput__placeHolder'>Chọn mã sản phẩm thêm vào hóa đơn</span>
              </div>
              <div className='formInput' style={{ width: 'calc(25% - 16px)' }}>
                <input type={'text'} className='formInput__input' placeholder=' ' autoComplete='off' />
                <span className='formInput__placeHolder'>Nhập số lượng mua</span>
              </div>
              <AcceptButton style={{ width: 'calc(30% - 16px)' }}>Thêm sản phẩm vào hóa đơn</AcceptButton>
              <div className='employees-management__table-wrapper'>
        ...
        {OpenTriggerDeleteModalRef && (
          <ModalBase styleContent={{ width: '600px', height: 'max-content' }} setOpen={setOpenTriggerDeleteModalRef}>
            <div className="employees-trigger-delete">
              ...
              <AcceptButton >Xác nhận bàn giao</AcceptButton>
            </div>
          </ModalBase>
        )} */}
        {/* Loading */}
