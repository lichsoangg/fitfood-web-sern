...
const schema = yup.object({
    ...
    confirmNewPassword: yup.string().required("Xác nhận mật khẩu mới là bắt buộc").oneOf([yup.ref("newPassword")], "Xác nhận mật khẩu mới không đúng"),
}).required();
        ...
        <>
            <FormProvider {...methods}>
                <form className='changePasswordForm' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Form.SubmitButton text="Cập nhật mật khẩu" styleButton={{ width: "200px", marginLeft: "auto" }} />
                </form>
            </FormProvider>
